...
function mostrarDetallePedido() {
  ...
  `;
    ...
    if (normalizar(pedido['ETAPA']) === 'CANCELADO') {
  const overlay = document.createElement('div');
  overlay.className = 'cancelado-overlay';
  overlay.textContent = 'CANCELADO';
  document.getElementById('detallePedido').appendChild(overlay);
}
